...
export const CartItem: React.FC<CartProps> = ({id, name, price, count, imageUrl, type, size}) => {
  ...
  return (
    ...
    <div className="cart__item-remove">
      <div className="button button--outline button--circle" onClick={onClickClearAll}>
        <svg
          width="10"
          height="10"
          viewBox="0 0 10 10"
